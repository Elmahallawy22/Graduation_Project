        ...
        <div className="flex items-center reletive">
          ...
          {showAct &&
            <ul className={`absolute -bottom-28 right-1 lg:right-40 bg-main px-3 py-2 space-y-2 rounded text-lg ${asNurse ? 'lg:-bottom-44':'lg:-bottom-36'} `}>
              ...
              {asNurse &&<li><Link href='' className="flex justify-around items-center">
                My funds<FaMoneyBillAlt className="ml-4" /></Link>  </li>}
              <li><Link href='/activity' className="flex justify-around items-center">
              ...
              <li className="border-t-2"><Link href='/' className="flex justify-around items-center">
                Log Out<FiLogOut className="ml-4" /></Link> </li>
            </ul>
          }
        </div>
        :
